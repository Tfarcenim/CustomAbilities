...
public class CommonSlider extends AbstractSliderButton {
     ...
     */
    public CommonSlider(int x, int y, int width, int height, Component prefix, Component suffix, double minValue, double maxValue, double currentValue, double stepSize, int precision, boolean drawString) {
     ...
     */
    public CommonSlider(int x, int y, int width, int height, Component prefix, Component suffix, double minValue, double maxValue, double currentValue, boolean drawString) {
    ...
    protected void applyValue() {
        Services.PLATFORM.sendToServer(new C2SSetPercentagePacket(value));
    }
    ...
    public int getFGColor() {
        return this.active ? 0xffffff : 0xa0a0a0; // White : Light Grey
    }
