...
public class ModEntityTypes {
    ...
    public static final EntityType<BubbleEntity> BUBBLE = register("bubble",EntityType.Builder.<BubbleEntity>of(BubbleEntity::new, MobCategory.MISC).fireImmune().sized(0.49F, 0.49F)
            .clientTrackingRange(10).updateInterval(10));
